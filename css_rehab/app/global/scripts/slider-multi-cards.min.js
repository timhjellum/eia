...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _sliderMultiCards = __webpack_require__(17);

	var _sliderMultiCards2 = _interopRequireDefault(_sliderMultiCards);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function checkSize() {
	    ...
	    if (elementWidth >= 801 && elementWidth <= 987) {
	        // element width / number of slides
	        var slideWidth = parseInt(elementWidth / 4);
	        ...
	        $(".bx-wrapper").css("width", elementWidth);
	        $(".bx-viewport").css("width", elementWidth);
	        $(".slider-multi-cards-container").css("width", elementWidth);

	        var elementHeight = $(".bx-viewport").height();
	        console.log(elementWidth + ' plus ' + elementHeight);

	        $(".bx-prev").css("height", elementHeight);
	        $(".bx-next").css("height", elementHeight);
	        $(".bx-controls-direction").css("top", -elementHeight);
	    } else if (elementWidth >= 600 && elementWidth <= 800) {
	        // element width / number of slides
	        var slideWidth = parseInt(elementWidth / 3);
	        ...
	        $(".bx-next").css("height", elementHeight);
	        $(".bx-controls-direction").css("top", -elementHeight);
	    } else if (elementWidth >= 450 && elementWidth <= 599) {

	        // element width / number of slides
	        var slideWidth = parseInt(elementWidth / 2);
	        ...
	        $(".bx-next").css("height", elementHeight);
	        $(".bx-controls-direction").css("top", -elementHeight);
	    } else if (elementWidth >= 320 && elementWidth <= 449) {

	        console.log("mobile slide width: " + elementWidth);
	        ...
	        $(".bxslider").bxSlider({
	            ...
	            prevText: "&#8249;",
	            infiniteLoop: true,
	            slideWidth: elementWidth,
	            slideMargin: 0
	        });
	        $(".thumbnail").css("width", elementWidth);
	        $(".thumbnail").css('height', elementWidth / 2);
	        $(".slide-content").css("width", elementWidth);
	        $(".bx-wrapper").css("width", elementWidth);
	        $(".bx-viewport").css("width", elementWidth);
	        $(".bx-controls-direction").css("width", elementWidth);
	        $(".bx-controls").css("width", elementWidth);
	        $(".slider-multi-cards-container").css("width", elementWidth);
	        ...
	        $(".slider-multi-cards-container").css("width", elementWidth);
	        $(".bx-wrapper").css("width", elementWidth);
	        $(".bx-wrapper").css("max-width", elementWidth);
