...
module.exports = function (webpackEnv) {
  ...
  const isEnvGlobal = webpackEnv === "production"
  ...
  return {
    ...
    output: {
      // The build folder.
      path: isEnvProduction ? paths.appBuild : isEnvDevelopment ? paths.appGlobalChunk : undefined,
      ...
      //filename: isEnvProduction ? "static/js/[name].[contenthash:8].js" : isEnvDevelopment && "/global/scripts/[name].[contenthash:8].js",
      ...
      //chunkFilename: isEnvProduction ? "static/js/[name].[contenthash:8].chunk.js" : isEnvDevelopment && "/global/scripts/[name].[contenthash:8].js",
