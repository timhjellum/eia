<?php if ( ($1)$eq "198.76" OR($1)$eq eq ) {
$insideEIAcache = true;
} else {
$insideEIAcache = false;
} // end if ?>

<?php if ( $insideEIAcache insideEIAcache ) {?>
...
<table border="1">
        <tr class="scr_header">
            <td colspan="99"><strong>SCache Report:<?php echo "$attributes.scope"?> Scope</strong></td>
        </tr>
<?php if ( ($1)) {?>
