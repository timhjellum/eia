...
echo "<p><a href='{$json_file}' target='_blank'>Open nat-m.json</a> <a href='natural-gas-chart.json' target='_blank'>Open natural-gas-chart.json</a> <a href='natural-gas-chart2.json' target='_blank'>Open natural-gas-chart2.json</a> </p>";
$area= [
...
echo $output;
echo '</pre>';
$natural_gas_file = fopen("natural-gas-chart3.json", "w") or die("Unable to open/create natural-gas-chart3.json file!");
