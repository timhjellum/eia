...
case '2':
$radio_buttons = "<p>View: <a href=\"./?table=2&table_key={$this->table_array['2']['tablekeys']['W'][0][0]}&period=W\">Data series</a> or
<a href=\"./?table=2area&table_key={$this->table_array['2area']['tablekeys']['W'][0][0]}&period=W\">Area</a></p>";
break;
default:
$radio_buttons = null;
break;
