...
/***/ (function(module, exports, __webpack_require__) {
	    ...
	    _createClass(ParallaxModule, [{
	        ...
	        value: function checkSize() {
	            ...
	            if (viewPortWidth >= 801 && viewPortWidth <= 987) {
	                var p = new _Parallax2.default('.parallax', { tabletLandscape: tabletLandscape }).init();
	                console.log(tabletLandscape);
	            } else if (viewPortWidth >= 600 && viewPortWidth <= 800) {
	                var p = new _Parallax2.default('.parallax', { tablet: tablet }).init();
	                console.log(tablet);
	            } else if (viewPortWidth >= 450 && viewPortWidth <= 599) {
	                var p = new _Parallax2.default('.parallax', { mobileLandscape: mobileLandscape }).init();
	                console.log(mobileLandscape);
	            } else if (viewPortWidth >= 320 && viewPortWidth <= 449) {
	                var p = new _Parallax2.default('.parallax', { mobile: mobile }).init();
	                console.log(mobile);
	            } else {
	                var p = new _Parallax2.default('.parallax', { laptop: laptop }).init();
	                console.log(laptop);
	            }
	        }
	    }]);
	...
	exports.default = ParallaxModule;
