...
class ResponsiveImageFrame extends Component {
	constructor() {
		super()
		const initialCodeString = `<div class="image-container">\n  <img src="/" alt="Refer to: Alt tags best practices" class="responsive frame" />\n</div>`
		this.state = {
			selected: tomorrow,
					...
					<div className="l-row l-two-col-right">
						<div className="l-col">
							<div className="image-container">
								<img src={require("../../assets/images/main.png")} alt="Bab el-Mandeb Strait" className="responsive frame" />
							</div>
						</div>
						<div className="l-col">
							<div className="image-container">
