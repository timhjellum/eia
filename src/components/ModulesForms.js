...
<div className="_module-wrapper">
	<div className="_module-container">
		<div className="l-row l-two-col-left">
			<div className="l-col">
			<span className="attribute-name"><code>fieldset</code></span>
...
<div className="l-row l-two-col-left">
<div className="l-col">
<span className="attribute-name"><code>disabled</code></span>
...
<div className="l-row l-two-col-left">
<div className="l-col">
<span className="attribute-name"><code>action</code></span>
<p className="_p">Defines which URL the form's information is sent to when submitted.</p>
</div>
<div className="l-col">
<span className="attribute-name"><code>"/contact"</code></span>
...
<div className="l-row l-two-col-left">
<div className="l-col">
<h4 className="_h4">method</h4>
<p className="_p">Defines the HTTP method used when submitting the form.</p>
</div>
<div className="l-col">
<span className="attribute-name"><code>"post"</code></span>
...
<div className="l-col">
<span className="attribute-name"><code>"off"</code></span>
...
<Top />
<h4 className="_h4"><code>"on"</code></h4>
...
<div className="l-row l-two-col-left">
<div className="l-col">
<h4 className="_h4">target</h4>
<p className="_p">Defines in which tab or window the clicked link will show up.</p>
</div>
<div className="l-col">
<span className="attribute-name"><code>"_blank"</code></span>
...
<Top />
<h4 className="_h4"><code>"_self"</code></h4>
...
<Top />
<h4 className="_h4"><code>"_parent"</code></h4>
...
<Top />
<h4 className="_h4"> <code>"_top"</code></h4>
...
<span className="attribute-name"><code>"application/x-www-form-urlencoded"</code></span>
...
<Top />
<h4 className="_h4"><code>"text/plain"</code></h4>
...
<Top />
<h4 className="_h4"><code>"multipart/form-data"</code></h4>
...
<div className="l-row l-two-col-left">
<div className="l-col">
<span className="attribute-name"> <code>novalidate</code></span>
...
<Top />
<span className="attribute-name"><code>"number"</code></span>
...
<span className="attribute-name"><code>"checkbox"</code></span>
...
&lt;li className="custom-checkbox"&gt;&lt;input type="checkbox" name="lists" className="custom-checkbox-input" value="valueOne" id="valueOne"&gt;&lt;label htmlFor="valueOne" className="custom-checkbox-label"&gt;&lt;span className="custom-checkbox-label-inside"&gt;&lt;a&gt;Label One&lt;/a&gt;&lt;/span&gt;&lt;/label&gt;&lt;/li&gt;
&lt;li className="custom-checkbox"&gt;&lt;input type="checkbox" name="lists" className="custom-checkbox-input" value="valueTwo" id="valueTwo"&gt;&lt;label htmlFor="valueTwo" className="custom-checkbox-label"&gt;&lt;span className="custom-checkbox-label-inside"&gt;&lt;a&gt;Label Two&lt;/a&gt;&lt;/span&gt;&lt;/label&gt;&lt;/li&gt;
&lt;li className="custom-checkbox"&gt;&lt;input type="checkbox" name="lists" className="custom-checkbox-input" value="valueThr" id="valueThr"&gt;&lt;label htmlFor="valueThr" className="custom-checkbox-label"&gt;&lt;span className="custom-checkbox-label-inside"&gt;&lt;a&gt;Label Thr&lt;/a&gt;&lt;/span&gt;&lt;/label&gt;&lt;/li&gt;
&lt;li className="custom-checkbox"&gt;&lt;input type="checkbox" name="lists" className="custom-checkbox-input" value="valueFou" id="valueFou"&gt;&lt;label htmlFor="valueFou" className="custom-checkbox-label"&gt;&lt;span className="custom-checkbox-label-inside"&gt;&lt;a&gt;Label Fou&lt;/a&gt;&lt;/span&gt;&lt;/label&gt;&lt;/li&gt;
&lt;/ul&gt;</code></pre>

<span className="_example">
<ul className="checkbox-container">
<li className="custom-checkbox"><input type="checkbox" name="lists" className="custom-checkbox-input" value="valueOne" id="valueOne"><label htmlFor="valueOne" className="custom-checkbox-label"><span className="custom-checkbox-label-inside"><a href="/">Label One</a></span></label></li>
<li className="custom-checkbox"><input type="checkbox" name="lists" className="custom-checkbox-input" value="valueTwo" id="valueTwo"><label htmlFor="valueTwo" className="custom-checkbox-label"><span className="custom-checkbox-label-inside"><a href="/">Label Two</a></span></label></li>
<li className="custom-checkbox"><input type="checkbox" name="lists" className="custom-checkbox-input" value="valueThr" id="valueThr"><label htmlFor="valueThr" className="custom-checkbox-label"><span className="custom-checkbox-label-inside"><a href="/">Label Thr</a></span></label></li>
<li className="custom-checkbox"><input type="checkbox" name="lists" className="custom-checkbox-input" value="valueFou" id="valueFou"><label htmlFor="valueFou" className="custom-checkbox-label"><span className="custom-checkbox-label-inside"><a href="/">Label Fou</a></span></label></li>
</ul>
</span>
...
<span className="_example">
<ul>
<li className="custom-checkbox"><input type="checkbox" name="lists" className="custom-checkbox-input" value="Terms" id="Terms"><label htmlFor="Terms" className="custom-checkbox-label">I accept the terms</label></li>
</ul>
</span>
...
<span className="attribute-name"><code>"radio"</code></span>
...
<div className="l-row l-two-col-left">
<div className="l-col">
<span className="attribute-name"><code>name</code></span>
...
<div className="l-col">
<span className="attribute-values"><code>"first_name"</code></span>
...
<div className="l-col">
<span className="attribute-name"><code>"e.g. alex@smith.com"</code></span>
...
<div className="l-row l-two-col-left">
<div className="l-col">
<span className="attribute-name"> <code>required</code></span>
...
<div className="l-row l-two-col-left">
<div className="l-col">
<span className="attribute-name"> <code>legend</code></span>
...
<div className="l-col">
<span className="attribute-values"><code>"message"</code></span>
<p className="_p">The name value must be unique within the context of a <code>&lt;form&gt;</code> container.</p>
<p className="_p">It can only contain alphanumeric characters <code>a-z</code> <code>A-Z</code> <code>0-9</code> and some special characters like <code>-</code> <code>_</code>… but no space.</p>
<span className="_example">
...
<div className="l-row l-two-col-left">
<div className="l-col">
<h4 className="_h4">maxlength</h4>
<p className="_p">Defines the maxlength amount of characters allowed.</p>
</div>
<div className="l-col">
<span className="attribute-name"><code>"140"</code></span>
<p className="_p">You can use <strong>integers</strong>.</p>
...
<div className="l-col">
<span className="attribute-name"><code>"e.g. Hello my name is Alex"</code></span>
...
<div className="l-row l-two-col-left">
<div className="l-col">
<h4 className="_h4">cols</h4>
<p className="_p">Defines the number of columns.</p>
</div>
<div className="l-col">
<span className="attribute-name"><code>"40"</code></span>
<p className="_p">You can use <strong>integers</strong>.</p>
...
<div className="l-row l-two-col-left">
<div className="l-col">
<h4 className="_h4">rows</h4>
<p className="_p">Defines the number of rows.</p>
</div>
<div className="l-col">
<span className="attribute-name"><code>"2"</code></span>
<p className="_p">You can use <strong>integers</strong>.</p>
...
<div className="l-row l-two-col-left">
<div className="l-col">
<h4 className="_h4">wrap</h4>
<p className="_p">Defines how the text should be wrapped.</p>
</div>
<div className="l-col">
<span className="attribute-name"><code>"hard"</code></span>
...
<span className="attribute-values"><code>"soft"</code></span>
...
<div className="l-row l-two-col-left">
<div className="l-col">
<span className="attribute-name"><code>autofocus</code></span>
...
<div className="l-row l-two-col-left">
<div className="l-col">
<span className="attribute-name"><code>readOnly</code></span>
...
<div className="l-row l-two-col-left">
<div className="l-col">
<span className="attribute-name"><code>spellCheck</code></span>
