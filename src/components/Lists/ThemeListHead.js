...
import ThemeListHeadExample from "./ThemeListHeadExample"

class ThemeListHead extends Component {
	constructor() {
		super()
		const initialCodeString = `<li class="head">Lorem ipsum dolor sit amet</li>`
		this.state = {
			selected: tomorrow,
