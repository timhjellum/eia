...
import ThemeSubListExample from "./_ThemeSubListExample"

class ThemeSubList extends Component {
	constructor() {
		super()
		const initialCodeString = `<li class="sub-list">\n  <ul>\n    <li>Lorem ipsum dolor sit amet</li>\n    <li>Lorem ipsum dolor sit amet</li>\n    <li>Lorem ipsum dolor sit amet</li>\n  </ul>\n</li>`
		this.state = {
			selected: tomorrow,
