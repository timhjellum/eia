...
import ThemeListFootExample from "./ThemeListFootExample"

class ThemeListFoot extends Component {
	constructor() {
		super()
		const initialCodeString = `<li class="foot">Lorem ipsum dolor sit amet</li>`
		this.state = {
			selected: tomorrow,
