...
import ThemeListHighlightExample from "./ThemeListHighlightExample"

class ThemeListHighlight extends Component {
	constructor() {
		super()
		const initialCodeString = `<ul class="highlight">\n  <li>Lorem ipsum dolor sit amet</li>\n  <li>Lorem ipsum dolor sit amet</li>\n  <li>Lorem ipsum dolor sit amet</li>\n</ul>`
		this.state = {
			selected: tomorrow,
...
export default ThemeListHighlight
