		...
		return (
			<Page title="Modules">
				<span className="modules">
					<h1 className="_h1">Modules</h1>
					<h3 className="_h3">Module Rules</h3>

					<p className="_p">
						A module is a stand-along component of the page. It is your report header, content containers, carousels, messaging and dialogs, et al. This is the meat of the page. Modules sit inside <strong>Layouts</strong> and inherit their styles by <strong>Themes</strong>. Modules can sometimes sit within other Modules, too. Each Module should be designed to exist as a standalone component. In doing so, the page will be more flexible. If done right, Modules can easily be moved to different parts of the layout without breaking.
					</p>
					...
					<p className="_p">The problem is that as a project grows in complexity, the more likely that you will need to expand a component’s functionality and the more limited you will be in having used such a generic element within your rule.</p>
					...
					<p className="_p">
						Modules are the reusable and modular components of the page. Modules can be <strong>nested</strong> and each Module should be designed to exist as a <strong>standalone component</strong>. In doing so, the page will be more flexible. If done right, Modules can easily be moved to different parts of the layout without breaking.
					</p>
					...
					<p className="_p">Use child or descendant selectors with element selectors if the element selectors will and can be predictable. Using .module span is great if a span will predictably be used and styled the same way every time while within that module.</p>
					...
					<p className="_p">We are doubling up on our selectors to be able to override the specificity of #sidebar.</p>
					<p className="_p">What we should do instead is recognize that the constrained layout in the sidebar is a subclass of the pod and style it accordingly.</p>
