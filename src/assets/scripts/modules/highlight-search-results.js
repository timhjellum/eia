	...
	constructor() {
		...
		if (window.location.href.indexOf("query=") > -1) {
			...
			if (checkIfQuery == true) {
				var accordionWrapperInner = document.getElementsByClassName(
					"accordion"
				)[0].innerHTML;
				var accordionWrapper = document.getElementsByClassName(
					"accordion"
				)[0];
				...
				if (search.length > 0)
					accordionWrapper.innerHTML = accordionWrapperInner.replace(
						re,
						"<mark>$&</mark>"
					);
