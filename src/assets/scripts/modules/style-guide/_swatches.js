...
*/
        $(function() {
            ...
            $(".eia-dark-orange").html($(".eia-dark-orange").css("backgroundColor"));
            $(".eia-dark-orange-75").html($(".eia-dark-orange-75").css("backgroundColor"));
            $(".eia-dark-orange-50").html($(".eia-dark-orange-50").css("backgroundColor"));
            $(".eia-dark-orange-25").html($(".eia-dark-orange-25").css("backgroundColor"));
            $(".eia-orange").html($(".eia-orange").css("backgroundColor"));
            $(".eia-light-orange-25").html($(".eia-light-orange-25k").css("backgroundColor"));
            $(".eia-light-orange-50").html($(".eia-light-orange-50").css("backgroundColor"));
            $(".eia-light-orange-75").html($(".eia-light-orange-75").css("backgroundColor"));
            $(".eia-light-orange").html($(".eia-light-orange").css("backgroundColor"));
