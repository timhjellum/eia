...
$(".accordion.first-open > h3:first-of-type")
	.removeClass("ui-accordion-header-collapsed")
	.addClass("ui-accordion-header-active")
	.attr({ "aria-selected": "true", tabindex: "0" });
$(".accordion.first-open > div:first-of-type")
	.addClass("ui-accordion-content-active")
	.attr({ "aria-expanded": "true", "aria-hidden": "false" })
	.show();
$(".accordion.first-open > h3:first-of-type span")
	.addClass("collapse")
	.removeClass("expand")
	.css("display", "block");
