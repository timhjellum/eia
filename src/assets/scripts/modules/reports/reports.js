...
(function() {
    ...
    $(document).ready(function() {
        ...
        function positionFrequencyMenu() {
            frequencyMenu.position({
                left: frequencyButton.position().left -
        ...
        if (
            ...
            var selectedFilter = $.cookie("lastFilter") ?
                $.cookie("lastFilter") :
                "all";
        ...
        console.log("the cookie value is: " + selectedFilter)
        ...
        var jqHXR = $.ajax({
            ...
            .done(function(data, textStatus, jqHXR) {
                ...
                if (!tags.length) {
                    ...
                    var curFilter =
                        typeof $.cookie("lastFilter") == "string" ?
                        $.cookie("lastFilter").toLowerCase() :
                        "all";
                    // var curFilter =  'all';
                    renderTags();
                ...
                if (typeof data.reports == "undefined") {
                    ...
                    if (!reportsJSON.length) {
                        ...
                        for (
                            var oneReport = 0; oneReport < reportsJSON.length; oneReport++
                        ) {
    ...
    function setLastCatDspy(filter) {
        ...
        var curCatIdx =
            typeof $.cookie(lastState) == "string" ? $.cookie(lastState) : 0;
        var categoryId = $(
