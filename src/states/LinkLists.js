	...
	render() {
		return (
			<div className="right-content">
				<p className="_p">
					Some editible include files contain editible variables which write the
					values to corresponding HTML elements. Notice the fourth and fifth
					variables have been left blank.
				</p>
				<Legend />
				...
				<Top />
				<p className="_p">
					Here's how the link list would display on the page with the fourth and
					fifth list items hidden from the user.
				</p>
				<Legend />
				<div className="_module-wrapper">
					<div className="_module-container">
