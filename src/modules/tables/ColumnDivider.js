  ...
  render() {
    return (
      <li className="section-container">
        ...
        <p className="_p">
          Adding a <code>className="divider"</code> to the table cell before
          where you want the divider to go.
        </p>
                ...
                <table className="basic-table full-width">
                  <thead>
                    <tr>
                      ...
                      <th colspan="3">Aligned center by default</th>
                    </tr>
                    <tr>
                      <th className="divider">Align left</th>
                      <th>Aligned right</th>
                      <th>Aligned right</th>
                      <th>Aligned right</th>
                    </tr>
                  ...
                  <tbody>
                    <tr>
                      <td className="divider">Align left</td>
                      <td>Aligned right</td>
                      <td>Aligned right</td>
                      <td>Aligned right</td>
                    </tr>
                    ...
                    <tr className="total">
                      <td className="divider">Total Row</td>
                      <td>Total Row</td>
                      <td>Total Row</td>
                      <td>Total Row</td>
                    </tr>
