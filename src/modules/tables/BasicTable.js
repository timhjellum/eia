	...
	render() {
		return (
			<div class="right-content">
				...
				<p className="_p">
					A table’s complexity and needs can vary greatly. This
					pattern provides many different features a table{" "}
					<em>may</em> have. Features can be mixed and matched based
					on your needs. Don’t include features unless they’re
					actually needed.
				</p>
