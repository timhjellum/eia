	...
	render() {
		return (
			<div class="right-content">
				...
				<p className="_p">
					Highlighting a column (body and foot, not the head) by
					adding a <code>highlight-col-x</code> to the{" "}
				...
				<div className="_example _html">
					<pre>
						<code className="html">
							...
							&lt;!-- highlight the second and fourth columns
							--&gt; &lt;table className="highlight-col-2
							highlight-col-4"&gt;&lt;/div&gt;
						</code>
					</pre>
				</div>
