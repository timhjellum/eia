							...
							<div className="l-col">
								<div className="primary">
									...
									<p>
										...
										adipiscing elit. Nunc lacus nulla,
										interdum a tellus eu, sollicitudin
										lobortis felis. Curabitur fermentum
										tristique rhoncus. Maecenas aliquam,
										odio tincidunt aliquam malesuada, dolor
										tellus finibus leo, vitae justo nulla ac
										neque.
									</p>
									<span className="h2_module-bg">
										<span className="h2_border">
											<h2>
												.primary h2 - The five boxing
												wizards jump quickly
											</h2>
										</span>
									</span>
