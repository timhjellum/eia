	...
	render() {
		return (
			<div class="right-content">
				...
				<div class="swatch-wrapper">
					<div class="swatch" style="background-color:#003851;">
						<span>#003851;</span>
					</div>
				</div>
				<div class="swatch-wrapper">
					<div class="swatch" style="background-color:#003c57;">
						<span>#003c57;</span>
					</div>
				</div>
				<div class="swatch-wrapper">
					<div class="swatch" style="background-color:#00405d;">
						<span>#00405d;</span>
					</div>
				</div>
				<div class="swatch-wrapper">
					<div class="swatch" style="background-color:#0096d7;">
						<span>#0096d7;</span>
					</div>
				</div>
				<div class="swatch-wrapper">
					<div class="swatch" style="background-color:#189bd7;">
						<span>#189bd7;</span>
					</div>
				</div>
				<div class="swatch-wrapper">
					<div class="swatch" style="background-color:#4db6e3;">
						<span>#4db6e3;</span>
					</div>
				</div>
				...
				<h3 class="_h3">Consolidate</h3>
				<div class="swatch-wrapper">
					<div class="swatch" style="background-color:#a33340;">
						<span>#a33340;</span>
					</div>
				</div>
				...
				<h3 class="_h3">Consolidate</h3>
				<div class="swatch-wrapper">
					<div class="swatch" style="background-color:#5e625e;">
						<span>#5e625e;</span>
					</div>
				</div>
				<div class="swatch-wrapper">
					<div class="swatch" style="background-color:#666666;">
						<span>#666666;</span>
					</div>
				</div>
				<div class="swatch-wrapper">
					<div class="swatch" style="background-color:#7d7d7d;">
						<span>#7d7d7d;</span>
					</div>
				</div>
				<div class="swatch-wrapper">
					<div class="swatch" style="background-color:#7e7c6f;">
						<span>#7e7c6f;</span>
					</div>
				</div>
				<div class="swatch-wrapper">
					<div class="swatch" style="background-color:#858585;">
						<span>#858585;</span>
					</div>
				</div>
				<div class="swatch-wrapper">
					<div class="swatch" style="background-color:#999999;">
						<span>#999999;</span>
					</div>
				</div>
				...
				<h3 class="_h3">Consolidate</h3>
				<div class="swatch-wrapper">
					<div class="swatch" style="background-color:#a6a5a6;">
						<span>#a6a5a6;</span>
					</div>
				</div>
				<div class="swatch-wrapper">
					<div class="swatch" style="background-color:#b3c2c9;">
						<span>#b3c2c9;</span>
					</div>
				</div>
				<div class="swatch-wrapper">
					<div class="swatch" style="background-color:#d3d3d3;">
						<span>#d3d3d3;</span>
					</div>
				</div>
				<div class="swatch-wrapper">
					<div class="swatch" style="background-color:#d8d8d8;">
						<span>#d8d8d8;</span>
					</div>
				</div>
				<div class="swatch-wrapper">
				...
				<div class="swatch-wrapper">
					<div class="swatch" style="background-color:#dff2fB;">
						<span>#dff2fB;</span>
					</div>
				</div>
				<div class="swatch-wrapper">
					<div class="swatch" style="background-color:#e8cccf;">
						<span>#e8cccf;</span>
					</div>
				</div>
				<div class="swatch-wrapper">
					<div class="swatch" style="background-color:#e8ecf2;">
						<span>#e8ecf2;</span>
					</div>
				</div>
				<div class="swatch-wrapper">
					<div class="swatch" style="background-color:#f5fbfd;">
						<span>#f5fbfd;</span>
					</div>
				</div>
				<div class="swatch-wrapper">
					<div class="swatch" style="background-color:#f7f7f7;">
						<span>#f7f7f7;</span>
					</div>
				</div>
				<div class="swatch-wrapper">
					<div class="swatch" style="background-color:#f9f9f9;">
						<span>#f9f9f9;</span>
					</div>
				</div>
				...
				<div class="swatch-wrapper">
					<div class="swatch" style="background-color:#66a0b9">
						<span>@eia-muted-blue</span>
					</div>
				</div>
				<div class="swatch-wrapper">
					<div class="swatch" style="background-color:#92a753">
						<span>@eia-muted-green</span>
					</div>
				</div>
				<div class="swatch-wrapper">
					<div class="swatch" style="background-color:#a27d33">
