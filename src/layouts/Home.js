	...
	render() {
		return (
			<div className="right-content">
				...
				<p className="_p">
					...
					<a href="examples.html">columns</a>. You should be familiar with both
					in order to use them correctly. Below are the available page layouts:
				</p>
				{/*
        <a
		...
		*/}
				...
				<p className="_p">
					...
					system for the page layouts. The page layouts allow for the pages and
					elements on the page to be responsive based on the users' media device
					(e.g. print, mobile, laptop, desktop). To accomplish this, we use
					break points based off of the width of the users' media device. The
					...
					<table className="basic-table align-left-col-4">
						...
						<tbody>
							...
							<tr>
								...
								<td>955</td>
								<td>
									Tablet, landscape iPad, lo-resolution laptops and desktops
								</td>
							</tr>
							<tr>
								<td>laptop</td>
							...
							<tr>
								...
								<td>2299</td>
								<td>
									Big landscape tablets, hi-resolution laptops, and desktops
								</td>
							</tr>
							<tr>
								<td>desktop-lg</td>
							...
							<tr>
								...
								<td>599px</td>
								<td>
									Mmartphones, portrait iPhone, portrait 480x320 phones
									(Android)
								</td>
							</tr>
						</tbody>
				...
				<div className="notice">
					<p>
						Notice that on the upper right of every page of this style-guide
						there's a small box with the resolution defined media-query type
						that you are viewing this page.
					</p>
				</div>
				...
				<ul className="_ul">
					<li>
						All style naming conventions use classes and not ID selectors.
					</li>
				...
				<div className="_example">
					...
					<pre>
						<code className="html">
							&lt;!-- examples of bad naming conventions --&gt; &lt;div
							id="Row"&gt;&lt;/div&gt; &lt;div
				...
				<div className="_example">
					...
					<pre>
						<code className="html">
							&lt;!-- examples of bad naming conventions --&gt; &lt;div
							className="l-row l-header"&gt;&lt;/div&gt; &lt;div
							className="l-col"&gt; &lt;/div&gt;
						</code>
					</pre>
				</div>
