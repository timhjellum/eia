...
import LoremIpsumList from "../assets/containers/LoremIpsumList";
import IconicListItems from "./lists/IconicListItems";
import ExamplePlaceholder from "../assets/examples/ExamplePlaceholder";
	...
	render() {
		return (
			<div className="right-content">
				...
				<p className="_p">
					Article themes have bulletid lists by default. Primary and Secondary
					lists do not have bulletid lists by default and therefore adding the{" "}
					<code>bullet</code> class is required to force bullets.
				</p>
				<Legend />
				<div className="_module-wrapper">
					<div className="_module-container">
						...
						<span className="_module-bg">
							<div className="primary">
								<ul className="numbered">
									<li>
										<span className="number">001</span>Lorem ipsum dolor sit
										amet, consectetur adipiscing elit. Lorem ipsum dolor sit
										amet, consectetur adipiscing elit. Lorem ipsum dolor sit
										amet, consectetur adipiscing elit.
									</li>
									<li>
										<span className="number">002</span>Lorem ipsum dolor sit
										amet, consectetur adipiscing elit.
									</li>
									<li>
										<span className="number">003</span>Lorem ipsum dolor sit
										amet, consectetur adipiscing elit.
									</li>
								</ul>
							</div>
