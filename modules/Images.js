...
class Images extends Component {
	render() {
		return (
			<div className="right-content">
				...
				{/*
				<p className="_p">
					Please refer to the <a href="fancybox.html">FancyBox Modal section</a>{" "}
					for modal functionality of images.
				</p>
				...
				<Top />
				<h1 className="_h1">Images</h1>
				<h3 className="_h3">Responsive Images for 1x and 2x Display Types.</h3>
				<p className="_p">
					When should You Make Both 1x and 2x Graphics?
					<br />
					Most (if not all) of today’s mobile phones and tablets have 2x or
					higher resolution screens, so the non-@2x are optional for the image
					with the media queries of 479px and 800px. However, if the procedure
					is automated, the 1x images are best practices.
					<br />
					While most laptops and desktops have 1x screens, it's best to create
					@2x versions.
				</p>
				<p className="_p">
					The responsive code that has the minimal number of image to create (3
					to 6) and is the most simple to implement.
				</p>
				...
				<p className="_p">
					Assuming the image is full width these common layouts provide the a
					variable.
				</p>
	...
	Full-Width Column<br /><code>l-row l-full-width-col</code>
					...
					<p className="_p">l-full-width-col main column width = 934</p>
				</div>
				<Legend />
				<div className="_module-wrapper">
					<div className="_module-container">
				...
				<p className="_p">
					The <code>&lt;picture&gt;</code> element is currently available Chrome
					38. Try it out with screen emulation in the Chrome DevTools.
				</p>
					*/}
				<ExamplePlaceholder />
				<Top />
