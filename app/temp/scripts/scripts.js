...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Header = function Header() {
	    ...
	    $("._header").html('<a class="logo" href="/">' + '<h1>U.S. Energy Information Administration - EIA - Independent Statistics and Analysis</h1>' + '</a>' + '<ul class="nav-primary">' + '<li class="nav-primary-item">' + '<a class="fancybox-menu">Base</a>' + '</li>' + '<li class="nav-primary-item">' + '<a class="fancybox-menu">Layouts</a>' + '</li>' + '<li class="nav-primary-item">' + '<a class="fancybox-menu">Modules</a>' + '</li>' + '<li class="nav-primary-item">' + '<a class="fancybox-menu">States</a>' + '</li>' + '<li class="nav-primary-item">' + '<a class="fancybox-menu"Themes</a>' + '</li>' + '</ul>');
	};
