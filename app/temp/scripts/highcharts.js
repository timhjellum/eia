...
/***/ (function(module, exports, __webpack_require__) {
	...
	new _highcharts2.default(); //const $ = require("jquery");
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } } //import highCharts from '../../../../node_modules/highcharts/highcharts.js';

	var HighCharts = function HighCharts() {
	    _classCallCheck(this, HighCharts);

	    console.log('high charts checking in!');
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function () {
	  ...
	  */
		function _attr(elem, prop, value) {
			var key,
	  ...
	  */
		function createElement(tag, attribs, styles, parent, nopad) {
			...
			if (nopad) {
				_css(el, { padding: 0, border: NONE, margin: 0 });
			}
			if (styles) {
				_css(el, styles);
			}
	  ...
	  */
	   ...
	   */
			wrapColor: function wrapColor(length) {
	   ...
	   */
			wrapSymbol: function wrapSymbol(length) {
	    ...
	    */
	     ...
	     */
					$.fn.highcharts = function () {
						...
						if (options === UNDEFINED) {
							ret = charts[_attr(this[0], 'data-highcharts-chart')];
						}
	   ...
	   */
			attr: function attr(hash, val) {
				...
				if (isString(hash)) {
					...
					ret = _attr(element, key) || wrapper[key] || 0;
						...
						if (result !== false) {
							...
							if (key === 'd') {
								...
								for (i = 0; i < element.childNodes.length; i++) {
									...
									if (_attr(child, 'x') === _attr(element, 'x')) {
							...
							if (key === 'stroke-width' || key === 'stroke') {
								...
								if (wrapper.stroke && wrapper['stroke-width']) {
									_attr(element, 'stroke', wrapper.stroke);
									_attr(element, 'stroke-width', wrapper['stroke-width']);
							...
							if (shadows && /^(width|height|visibility|x|y|d|transform|cx|cy|r)$/.test(key)) {
								i = shadows.length;
								while (i--) {
									_attr(shadows[i], key, key === 'height' ? mathMax(value - (shadows[i].cutHeight || 0), 0) : value);
								}
							}
	   ...
	   */
			addClass: function addClass(className) {
				var element = this.element,
				    currentClassName = _attr(element, 'class') || '';

				if (currentClassName.indexOf(className) === -1) {
					_attr(element, 'class', currentClassName + ' ' + className);
				}
				return this;
			},
	  ...
	  */
			...
			css: function css(styles) {
				...
				if (hasNew) {
					...
					if (isIE && !hasSVG) {
						...
						_attr(elem, 'style', serializedCss); // #1881
					}
	   ...
	   */
			updateTransform: function updateTransform() {
				...
				if (transform.length) {
					_attr(wrapper.element, 'transform', transform.join(' '));
				}
			},
			/**
			...
			add: function add(parent) {
				...
				if (parentWrapper.handleZ) {
					...
					for (i = 0; i < childNodes.length; i++) {
						...
						otherZIndex = _attr(otherElement, 'zIndex');
			...
			shadow: function shadow(shadowOptions, group, cutOff) {
				...
				if (shadowOptions) {
					...
					for (i = 1; i <= shadowWidth; i++) {
						...
						if (cutOff) {
							_attr(shadow, 'height', mathMax(_attr(shadow, 'height') - strokeWidth, 0));
	  ...
	  */
	   ...
	   */
			buildText: function buildText(wrapper) {
				var textNode = wrapper.element,
				    ...
				    styleRegex = /<.*style="([^"]+)".*>/,
				    hrefRegex = /<.*href="(http[^"]+)".*>/,
				    parentX = _attr(textNode, 'x'),
				    textStyles = wrapper.styles,
				    width = wrapper.textWidth,
				    textLineHeight = textStyles && textStyles.lineHeight,
				    i = childNodes.length,
				    getLineHeight = function getLineHeight(tspan) {
					return textLineHeight ? pInt(textLineHeight) : renderer.fontMetrics(/(px|em)$/.test(tspan && tspan.style.fontSize) ? tspan.style.fontSize : textStyles.fontSize || 11).h;
				};
					...
					each(spans, function (span) {
						if (span !== '' || spans.length === 1) {
							...
							if (styleRegex.test(span)) {
								...
								_attr(tspan, 'style', spanStyle);
							}
							if (hrefRegex.test(span) && !forExport) {
								// Not for export - #1529
								_attr(tspan, 'onclick', 'location.href=\"' + span.match(hrefRegex)[1] + '\"');
							...
							if (span !== ' ') {
								...
								if (!spanNo && lineNo) {
									...
									_attr(tspan, 'dy', getLineHeight(tspan),
	   ...
	   */
			color: function color(_color, elem, prop) {
				var renderer = this,
				    colorObject,
				    regexRgba = /^rgba/,
				    gradName,
				...
				} else if (regexRgba.test(_color)) {
					colorObject = Color(_color);
					_attr(elem, prop + '-opacity', colorObject.get('a'));
	   ...
	   */
			fontMetrics: function fontMetrics(fontSize) {
							...
							if (!htmlGroup) {
								...
								each(parents.reverse(), function (parentGroup) {
									...
									htmlGroup = parentGroup.div = parentGroup.div || createElement(DIV, {
										className: _attr(parentGroup.element, 'class')
									}, {
										position: ABSOLUTE,
									...
									extend(parentGroup.attrSetters, {
										...
										visibility: function visibility(value, key) {
	  ...
	  */
	   ...
	   */
	    ...
	    * @param {Object} color The color or config object
	    */
				color: function color(_color2, elem, prop, wrapper) {
					var renderer = this,
					    colorObject,
					    regexRgba = /^rgba/,
					    markup,
					...
					if (_color2 && _color2.linearGradient) {
						fillType = 'gradient';
					} else if (_color2 && _color2.radialGradient) {
						fillType = 'pattern';
					}
					...
					if (fillType) {
						...
						var stopColor,
						    stopOpacity,
						    gradient = _color2.linearGradient || _color2.radialGradient,
						    x1,
						    y1,
						    x2,
						    y2,
					...
					} else if (regexRgba.test(_color2) && elem.tagName !== 'IMG') {

						colorObject = Color(_color2);
	    ...
	    */
	     ...
	     */
					...
					rect: function rect(left, top, width, height, options) {
	   ...
	   */
			getLabelSides: function getLabelSides() {
				var bBox = this.label.getBBox(),
				    ...
				    leftSide = horiz ? labelOptions.x - size * { left: 0, center: 0.5, right: 1 }[axis.labelAlign] : 0,
		...
		Axis.prototype.getTimeTicks = function (normalizedInterval, min, max, startOfWeek) {
			...
			if (defined(min)) {
				...
				var time = minDate.getTime(),
				    ...
				    localTimezoneOffset = useUTC ? timezoneOffset : (24 * 3600 * 1000 + minDate.getTimezoneOffset() * 60 * 1000) % (24 * 3600 * 1000); // #950
	  ...
	  */
	   ...
	   */
			runPointActions: function runPointActions(e) {
				...
				if (hoverSeries && hoverSeries.tracker && (!tooltip || !tooltip.followPointer)) {
					// only use for line-type series with common tracker and while not following the pointer #2584
	   ...
	   */
			drop: function drop(e) {
				...
				if (chart) {
					...
					_css(chart.container, { cursor: chart._cursor });
	   ...
	   */
			inClass: function inClass(element, className) {
				var elemClassName;
				while (element) {
					elemClassName = _attr(element, 'class');
					if (elemClassName) {
	   ...
	   */
			pinchTranslate: function pinchTranslate(zoomHor, zoomVert, pinchDown, touches, transform, selectionMarker, clip, lastValidTouch) {
				if (zoomHor) {
			...
			render: function render() {
				...
				if (legendBorderWidth || legendBackgroundColor) {
					...
					if (!box) {
						...
						box[box.isNew ? 'attr' : 'animate'](box.crisp({ width: legendWidth, height: legendHeight }));
						box.isNew = false;
					}
	  ...
	  */
	   ...
	   */
			getContainer: function getContainer() {
				...
				oldChartIndex = pInt(_attr(renderTo, indexAttrName));
				if (!isNaN(oldChartIndex) && charts[oldChartIndex] && charts[oldChartIndex].hasRendered) {
					charts[oldChartIndex].destroy();
				}

				// Make a reference to the chart from the div
				_attr(renderTo, indexAttrName, chart.index);
			...
			drawChartBox: function drawChartBox() {
				...
				if (plotBorderWidth) {
					if (!plotBorder) {
						...
						plotBorder.animate(plotBorder.crisp({ x: plotLeft, y: plotTop, width: plotWidth, height: plotHeight }));
					}
				}
	  ...
	  */
	   ...
	   *
	   */
			update: function update(options, redraw, animation) {
				var point = this,
				    series = point.series,
				    graphic = point.graphic,
				    i,
				...
				each(points, function (point) {
					...
					if (dataLabel && !enabled) {
						...
						if (dataLabel) {
							...
							str, 0, -999, null, null, null, options.useHTML).attr(attr).css(extend(options.style, cursor && { cursor: cursor })).add(dataLabelsGroup).shadow(options.shadow);
						}
	  ...
	  */
	   ...
	   */
			pan: function pan(e, panning) {
				...
				_css(chart.container, { cursor: 'move' });
			}
		});
...
/***/ (function(module, exports) {
	...
	(function (Highcharts, UNDEFINED) {
	   ...
	   */
			init: function init(options, chart, firstAxis) {
				var pane = this,
				    backgroundOption,
	  ...
	  */
	   ...
	   */
			getPlotLinePath: function getPlotLinePath(value, reverse) {
				var axis = this,
				    center = axis.center,
				    chart = axis.chart,
	  ...
	  *****************************************************************************/
	   ...
	   */
			applyOpacity: function applyOpacity(fill) {
	   ...
	   */
			getRadii: function getRadii(zMin, zMax, minSize, maxSize) {
				var len,
				    i,
				    pos,
				    zData = this.zData,
	   ...
	   * @param {Object} item The series (this) or point
	   */
			drawLegendSymbol: function drawLegendSymbol(legend, item) {
...
/***/ (function(module, exports) {
	...
	(function (Highcharts) {
	   ...
	   */
			getSVG: function getSVG(additionalOptions) {
				var chart = this,
				    chartCopy,
				    sandbox,
				    svg,
	   ...
	   */
			exportChart: function exportChart(options, chartOptions) {
				options = options || {};
	   ...
	   */
			contextMenu: function contextMenu(className, items, x, y, width, height, button) {
				...
				boxShadow = '3px 3px 10px #888',
				    ...
				    hideTimer,
				    menuStyle,
				    docMouseUpHandler = function docMouseUpHandler(e) {
