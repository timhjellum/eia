...
$('h3').click(function () {
	$('.accordion-content').each(function () {
		if ($(this).css('display') !== 'block') {
			console.log('accordion-content display not block so change the expand-all to collapse all');
			$('.expand-collapse-container .expand').css('display', 'block');
			$('.expand-collapse-container .collapse').css('display', 'none');
		}
	});
});
*/