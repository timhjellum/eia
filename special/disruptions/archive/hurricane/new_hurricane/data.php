      ...
      <div class="pagecontent mr_temp2">
        ...
        <div class="main_col">
          ...
          <table class="contable numeric">
            ...
            <thead id="summary">
              <tr>
                <th colspan="4"><a name="petroleum_fuel_facts" id="petroleum_fuel_facts"></a>U.S. Petroleum and Other Liquid Fuels Facts for 2010</th>
              </tr>
            </thead>
            <tr>
              <td colspan="2"><p>&nbsp;</p></td>
            ...
            <tr>
              <td colspan="2">Liquid Fuels Production </td>
              <td>9.8</td>
              <td>51%</td>
            </tr>
            <tr class="level2_indent">
              <td class="level2_indent" colspan="2" >U.S. Crude Oil Production </td>
              <td>5.5</td>
              <td>29%</td>
            </tr>
            <tr class="total level3_indent">
              <td colspan="2">Total Offshore Production <sup><a href="#1ftnotet1">1</a></sup></td>
              <td>1.7 </td>
              <td>9%</td>
            </tr>
            <tr class="level4_indent">
              <td colspan="2">Gulf of Mexico Offshore Production<sup><a href="#1ftnotet1">1</a></sup></td>
              <td>1.6</td>
              <td>8%</td>
            </tr>
            <tr class="level2_indent">
              <td colspan="2">Natural Gas Plant Liquids </td>
              <td>2.1</td>
              <td>11%</td>
            </tr>
            <tr class="level2_indent">
              <td colspan="2">Refinery Processing Gain </td>
              <td>1.1</td>
              <td>6%</td>
            </tr>
            <tr class="level2_indent">
              <td colspan="2">Biofuels</td>
              <td>0.9</td>
              <td>5%</td>
            </tr>
            <tr class="level2_indent">
              <td colspan="2">Other<sup><a href="#2ftnotet1">2</a></sup></td>
              <td>0.3</td>
              <td>2%</td>
            </tr>
            <tr>
              <td colspan="2">Stocks Withdrawn </td>
              <td>0</td>
              <td>0% </td>
            </tr>
            <tr>
              <td colspan="2">Net Imports </td>
              <td>9.4</td>
              <td>49%</td>
            </tr>
            <tr class="level2_indent">
              <td colspan="2">Gross Imports into Gulf Coast </td>
              <td>6.2</td>
              <td>33%</td>
            </tr>
            <tr class="total">
              <td colspan="2">Total U.S. Liquid Fuels Consumed<sup><a href="#3ftnotet1">3</a></sup>
              <td>19.2</td>
              <td>100%</td>
            </tr>
            <tr>
              <td colspan="3">Offshore share of U.S. crude oil production </td>
              <td>32%</td>
            </tr>
            <tr>
              <td colspan="3">Gulf of Mexico offshore share of U.S. crude oil production </td>
              <td>29%</td>
            </tr>
            <tr>
              <td colspan="4"><a name="1ftnotet1" id="1ftnotet1" style="margin-left:-1.5px;"></a>1. Includes Federal and State offshore production. <br />
            ...
            <?php /*thead id="prices">
              <tr>
                <th colspan="5"><a name="year_end_crude_ngl_reserves" id="year_end_crude_ngl_reserves"></a><strong>Year-End 2010 U.S. Proved Crude Oil, Condensate and Natural Gas Liquid Reserves</strong></th>
              </tr>
            </thead>
            <tr>
              <td>              
            <td colspan="4"><strong>Million Barrels</strong></tr>
            <tr>
              <td>              
            ...
            <thead id="reserves">
              <tr>
                <th colspan="4"><a name="nat_gas_facts" id="nat_gas_facts"></a><strong>Natural Gas Facts for 2010</strong></th>
              </tr>
            </thead>
            <tr>
              <td colspan="2"><p>&nbsp;</p></td>
            ...
            <tr>
              <td colspan="2">U.S. Dry Gas Production </td>
              <td>21.6</td>
              <td>90%</td>
            </tr>
            <tr class="level2_indent">
              <td colspan="2">Total Offshore Production</td>
              <td>2.7</td>
              <td>11%</td>
            </tr>
            <tr class="level3_indent">
              <td colspan="2">Gulf of Mexico Offshore Production <sup><a href="#1ftnotet1"></a></sup></td>
              <td>2.6 </td>
              <td>11%</td>
            </tr>
            <tr>
              <td colspan="2">Supplemental Gaseous Fuels<sup><a href="#1ftnotet1"></a></sup></td>
              <td >0.1</td>
              <td >0%</td>
            </tr>
            <tr>
            ...
            <tr class="level2_indent">
              <td colspan="2">LNG Imports into Gulf Coast </td>
              <td >0.1</td>
              <td >0%</td>
            </tr>
            <tr>
              <td colspan="2">Net Storage Withdrawals <sup><a href="#2ftnotet1"></a></sup></td>
              <td >0</td>
              <td >0%</td>
            </tr>
            <tr>
              <td colspan="2">Balancing Item</td>
              <td >-0.1</td>
              <td >0% </td>
            </tr>
            <tr class="total">
              <td colspan="2">Total U.S. Natural Gas Consumed</td>
              <td >24.1</td>
              <td >100%</td>
            </tr>
            <tr>
            ...
            <tr>
              <td colspan="3">Offshore Share of U.S. Natural Gas Production <sup><a href="#3ftnotet1"></a></sup></td>
              <td >13%</td>
            </tr>
            <tr>
              <td colspan="3">Gulf of Mexico Offshore Share of U.S. Natural Gas Production </td>
              <td >12%</td>
            </tr>
            <tr>
              <td colspan="4">Sources: U.S. Energy Information Administration, Natural Gas Monthly (July 2011), DOE Office of Fossil Energy Import/Export Data, and EIA estimates.</td>
            </tr>
            <?php /* END Natural Gas Facts Content ////////////////*/ ?>
            
            <?php /* BEGIN Year-End 2010 U.S. Natural Gas Proved Reserves Content ////////////////*/ ?>
            <?php /*thead id="consumption">
              <tr>
                <th colspan="5"><a name="year_end_nat_gas_reserves" id="year_end_nat_gas_reserves"></a><strong>Year-End 2010 U.S. Natural Gas Proved Reserves</strong></th>
              </tr>
            </thead>
            
            <tr>
              <td>&nbsp;</td>
              <td colspan="4"><strong>Million Barrels</strong></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td><strong>Crude Oil </strong></td>
            ...
            <thead id="production">
              <tr>
                <th colspan="4"><a name="gulf_coast_refinery" id="gulf_coast_refinery"></a><strong>U.S. Gulf Coast Operable Refinery Capacity As Of January 2011</strong></th>
              </tr>
            </thead>
            <tr>
              <td>&nbsp;</td>
         ...
         <td><strong><a href="/cneaf/coal/page/acr/table6.html">Average Sales Price by State, County, and Number of Mines</a></strong><br />
          ...
          <td><span class="right"><a href="/cneaf/coal/page/acr/table6.pdf" class="ico_pdf">PDF</a> <a href="/cneaf/coal/page/acr/table6.xls" class="ico_xls">XLS</a></span></td>
            ...
            <thead id="stocks">
              <tr>
                <th colspan="4"><a name="gulf_coast_processing" id="gulf_coast_processing"></a><strong>U.S. Gulf Coast Natural Gas Processing Plants by Geographic Location</strong></th>
              </tr>
            </thead>
            <tr>
              <td colspan="4"><strong>U.S. Gulf Coast Natural Gas Processing Plants by Geographic Location</strong></td>
            </tr>
            <tr>
            ...
            <tr>
              <td colspan="4">Note: Clusters refer to the geographic area  depicted on <a href="gom_cluster.cfm">Map</a>.<br/>
