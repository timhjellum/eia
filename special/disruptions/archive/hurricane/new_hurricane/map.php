...
<body onLoad="document.ckbs.reset();">
    ...
    <div class="pagecontent mr_temp4">
      ...
      <?php /* Main Column */ ?>
        ...
        <div style="height:539px;width:675px; margin-bottom:5px; background-color:#fff;" class="left do-not-print">
          ...
          <img src="images/gcei_electric-line.png" style="z-index:7; position:absolute;" id="elec_line"/>
          <img src="images/gcei_LNG.png" style="z-index:6; position:absolute;" id="lng"/>
          <img src="images/gcei_nat-gas-hubs.png" style="z-index:5; position:absolute;" id="nat_gas_hubs"/>
          <img src="images/gcei_nat-gas-pipelines.png" style="z-index:4; position:absolute;" id="nat_gas_pipelines"/>
          <img src="images/gcei_active-platforms.png" style="z-index:3; position:absolute;" id="platforms"/>
          <img src="images/gcei_map-bg.png" style="z-index:1; position:absolute;" id="map_bg"/>
		    ...
		    <form name="ckbs" id="ckbs" style="margin:0px;" class="do-not-print">
		      ...
		      <br/>
		      <input type="button" name="reset_map" value="Reset Map" class="pad_button"/>
