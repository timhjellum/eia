...
//                        echo '<strong>Setting column width for '.$columnID.' to '.$columnWidth.'</strong><br />';
...
//                    echo '<strong>Row '.$rowID.'</strong><br />';
...
//                            echo '<strong>comment found</strong><br />';
...
//                            echo '<strong>Setting row height to '.$rowHeight.'</strong><br />';
