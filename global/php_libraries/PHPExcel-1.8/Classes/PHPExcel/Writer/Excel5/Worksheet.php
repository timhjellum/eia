...
//            if ($row + 1 > 65536 or $column + 1 > 256) {
     ...
     *
     * <strong>Note:</strong> Excel writes some relative links with the $dir_long string. We ignore
     ...
     *
     * <strong>Note:</strong> The SDK says the record length is 0x0B but Excel writes a 0x0C
     * length record.
     *
