...
class PHPExcel_Calculation_Engineering
{
     ...
     *
     *    <strong>Note:</strong> In Excel 2007 or earlier, if you input a negative value for the upper or lower bound arguments,
     ...
     *
     *    <strong>Note:</strong> In Excel 2007 or earlier, if you input a negative value for the lower bound argument,
     *        the function would return a #NUM! error. However, in Excel 2010, the function algorithm was
