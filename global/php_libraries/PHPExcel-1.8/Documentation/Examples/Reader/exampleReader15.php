...
echo '<strong>Worksheet #',$sheetIndex,' -> ',$loadedSheetName,' (Formatted)</strong><br />';
...
echo '<hr />';
foreach($loadedSheetNames as $sheetIndex => $loadedSheetName) {
echo '<strong>Worksheet #',$sheetIndex,' -> ',$loadedSheetName,' (Unformatted)</strong><br />';
$objPHPExcel->setActiveSheetIndexByName($loadedSheetName);
...
echo '<hr />';
foreach($loadedSheetNames as $sheetIndex => $loadedSheetName) {
echo '<strong>Worksheet #',$sheetIndex,' -> ',$loadedSheetName,' (Raw)</strong><br />';
$objPHPExcel->setActiveSheetIndexByName($loadedSheetName);
