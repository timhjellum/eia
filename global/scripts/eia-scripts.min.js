	...
	var PageTabs = function () {
	    ...
	    _createClass(PageTabs, [{
	        ...
	        value: function onLoad() {
	            (0, _jquery2.default)(".page_tabs").tabs();
	            (0, _jquery2.default)(".page_tabs").localScroll({
	                target: ".page_tabs",
	                duration: 0,
	                hash: true
	            });
	            (0, _jquery2.default)(".rtitle_form").css("width", "30%");
	            (0, _jquery2.default)(".rtitle").css("width", "70%");
	        }
	    }]);
