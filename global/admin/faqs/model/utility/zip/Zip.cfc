...
<!------------------------------------------- CONSTRUCTOR ------------------------------------------->
	...
	<!--- getInstance --->
	<cffunction name="getInstance" returntype="struct" output="false" hint="I return my internal instance variables. All the cool java objects that i use to opperate.">
		<cfreturn instance />
	</cffunction>
