...
|| HISTORY ||
08/07/2009 Added init method - John Allen
--->
...
<!--- init --->
<cffunction name="init" returntype="File" access="public" output="false"
	displayname="init" hint="I return myself."
	description="I return myself.">
...
<!--- getMimeType --->
<cffunction name="getMimeType" returntype="string" output="No"
	hint="Return Mime Type based on lookup of file extension">
...
<!--- getFileProperties --->
<cffunction name="getFileProperties" access="public" returntype="struct" output="false" 
	description="Returns a struct of file information">
	
	<cfargument name="filename" type="string" required="true" 
		hint="The file to query" />
	...
	<cfdirectory 
		action="list" 
		name="qFile" 
		directory="#getDirectoryFromPath( arguments.filename )#" 
		filter="#getFileFromPath( arguments.fileName )#" />
